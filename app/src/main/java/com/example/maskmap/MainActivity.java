...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_menu_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!checkLocationServicesStatus()) { // GPS or 네트워크 활성화되었는지 검사
                    showDialogForLocationServiceSetting(); // 꺼져있으면 GPS 활성화
                }else {
                    checkRunTimePermission(); // 켜져있으면 런타임 퍼미션 얻기
                }
            }
        });
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        builder.setPositiveButton("설정", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                startActivityForResult(callGPSSettingIntent, GPS_ENABLE_REQUEST_CODE); // onActivityResult() 결과 확인
            }
        });
        builder.setNegativeButton("취소", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                dialog.cancel();
                showDialogForLocationServiceSetting(); // 취소를 눌러도 계속 묻기
            }
        });
        builder.create().show();
    }

    // 설정창에서 GPS 활성화했는지 결과를 알려주는 메소드
    @Override
        ...
        switch (requestCode) {
            ...
            case GPS_ENABLE_REQUEST_CODE:
                ...
                if (checkLocationServicesStatus()) {
                    ...
                    Toast.makeText(this, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.", Toast.LENGTH_LONG).show();
                    showDialogForLocationServiceSetting(); // 다시 GPS 권한 요청
                }
